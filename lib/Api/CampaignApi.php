...
class CampaignApi
{
     ...
     * @param  \Ebay\Sell\Marketing\Model\CloneCampaignRequest $body This type defines the fields for a clone campaign request. (required)
     *
     ...
     */
    public function cloneCampaignRequest($campaign_id, $body)
    {
     ...
     *
     * @param  \Ebay\Sell\Marketing\Model\CreateCampaignRequest $body This type defines the fields for the create campaign request. (required)
     *
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createCampaignRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Sell\Marketing\Model\Campaigns
     */
     ...
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Marketing\Model\Campaigns, HTTP status code, HTTP response headers (array of strings)
     */
    public function findCampaignByAdReferenceWithHttpInfo($inventory_reference_id = null, $inventory_reference_type = null, $listing_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Sell\Marketing\Model\Campaigns' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Sell\Marketing\Model\Campaigns', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ebay\Sell\Marketing\Model\Campaigns';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Sell\Marketing\Model\Campaigns',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function findCampaignByAdReferenceRequest($inventory_reference_id = null, $inventory_reference_type = null, $listing_id = null)
    {
        ...
        if ($listing_id !== null) {
            $queryParams['listing_id'] = $listing_id;
        }
     ...
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Sell\Marketing\Model\Campaign
     */
     ...
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Marketing\Model\Campaign, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignWithHttpInfo($campaign_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Sell\Marketing\Model\Campaign' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Sell\Marketing\Model\Campaign', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ebay\Sell\Marketing\Model\Campaign';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Sell\Marketing\Model\Campaign',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getCampaignByNameRequest($campaign_name)
    {
        ...
        // query params
        if (is_array($campaign_name)) {
            $campaign_name = ObjectSerializer::serializeCollection($campaign_name, '', true);
        }
     ...
     * @param  string $offset Specifies the number of campaigns to skip in the result set before returning the first report in the paginated response. Combine offset with the limit query parameter to control the items returned in the response. For example, if you supply an offset of 0 and a limit of 10, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If offset is 10 and limit is 20, the first page of the response contains items 11-30 from the complete result set. Default: 0 (optional)
     ...
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ebay\Sell\Marketing\Model\CampaignPagedCollection
     */
     ...
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Marketing\Model\CampaignPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignsWithHttpInfo($campaign_name = null, $campaign_status = null, $end_date_range = null, $limit = null, $offset = null, $start_date_range = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Sell\Marketing\Model\CampaignPagedCollection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Sell\Marketing\Model\CampaignPagedCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ebay\Sell\Marketing\Model\CampaignPagedCollection';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Sell\Marketing\Model\CampaignPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignsRequest($campaign_name = null, $campaign_status = null, $end_date_range = null, $limit = null, $offset = null, $start_date_range = null)
    {
        ...
        if (is_array($campaign_status)) {
            $campaign_status = ObjectSerializer::serializeCollection($campaign_status, '', true);
        }
        if ($campaign_status !== null) {
            $queryParams['campaign_status'] = $campaign_status;
        }
        // query params
        if (is_array($end_date_range)) {
            $end_date_range = ObjectSerializer::serializeCollection($end_date_range, '', true);
        }
        if ($end_date_range !== null) {
            $queryParams['end_date_range'] = $end_date_range;
        }
        // query params
        if (is_array($limit)) {
        ...
        // query params
        if (is_array($start_date_range)) {
            $start_date_range = ObjectSerializer::serializeCollection($start_date_range, '', true);
        }
        if ($start_date_range !== null) {
            $queryParams['start_date_range'] = $start_date_range;
        }
     ...
     *
     * @param  string $campaign_id A unique eBay-assigned ID for an ad campaign that&#39;s generated when a campaign is created. Get a seller&#39;s campaign IDs by calling getCampaigns. (required)
     * @param  \Ebay\Sell\Marketing\Model\UpdateCampaignIdentificationRequest $body This type defines the fields to updated the campaign name and start and end dates. (required)
     *
     * @throws \Ebay\Sell\Marketing\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCampaignIdentificationRequest($campaign_id, $body)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
