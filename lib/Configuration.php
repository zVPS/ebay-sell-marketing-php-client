...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.ebay.com/sell/marketing/v1';
    ...
    {
        $report  = 'PHP SDK (Ebay\Sell\Marketing) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.10.0' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.ebay.com/sell/marketing/v1",
