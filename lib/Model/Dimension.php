 ...
 *
 * @category Class
 * @description This type defines the annotation and dimension key used by the report. For information on how to set these values, see &lt;a href&#x3D;\&quot;/api-docs/sell/static/marketing/pl-reports.html\&quot;&gt;Reading Promoted Listings reports&lt;/a&gt;.
 * @package  Ebay\Sell\Marketing
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Dimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['annotation_keys'] = $data['annotation_keys'] ?? null;
     ...
     *
     * @param string[]|null $annotation_keys A list of annotations associated with the dimension of the report.
     *
     * @return self
     */
     ...
     * Sets dimension_key
     *
     * @param string|null $dimension_key The name of the dimension on which the report is based. A dimension is an attribute to which the report data applies.
     *
     * @return self
     */
