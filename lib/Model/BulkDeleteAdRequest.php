...
/**
 * BulkDeleteAdRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BulkDeleteAdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkDeleteAdRequest';
     ...
     * Gets requests
     *
     * @return \Ebay\Sell\Marketing\Model\DeleteAdRequest[]|null
     */
     ...
     * Sets requests
     *
     * @param \Ebay\Sell\Marketing\Model\DeleteAdRequest[]|null $requests An array of the listing IDs that identify the ads to remove. Note: This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return self
     */
