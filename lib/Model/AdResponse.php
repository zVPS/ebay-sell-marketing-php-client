...
class AdResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets ad_id
     *
     * @param string|null $ad_id A unique eBay-assigned ID for an ad. This ID is generated when an ad is created.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \Ebay\Sell\Marketing\Model\Error[]|null $errors An array of errors associated with the request.
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href The URI that points to the ad.
     *
     * @return self
     */
     ...
     * Sets listing_id
     *
     * @param string|null $listing_id A unique eBay-assigned ID for a listing that is generated when the listing is created. Note: This field accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param int|null $status_code An HTTP status code that indicates the response-status of the request. Check this code to see if the ad was successful created.
     *
     * @return self
     */
