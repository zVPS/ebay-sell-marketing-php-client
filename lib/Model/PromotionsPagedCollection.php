...
class PromotionsPagedCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'offset' => 'int',
        'prev' => 'string',
        'promotions' => '\Ebay\Sell\Marketing\Model\PromotionDetail[]',
        'total' => 'int'
    ];
     ...
     * Gets promotions
     *
     * @return \Ebay\Sell\Marketing\Model\PromotionDetail[]|null
     */
     ...
     * Sets promotions
     *
     * @param \Ebay\Sell\Marketing\Model\PromotionDetail[]|null $promotions A list containing the details of each returned promotion. This includes all the information about the promotions except for the listings that are part of the promotions.
     *
     * @return self
     */
