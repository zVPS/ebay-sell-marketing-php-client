...
/**
 * DeleteAdRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DeleteAdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteAdRequest';
     ...
     * Sets listing_id
     *
     * @param string|null $listing_id A unique eBay-assigned ID for a listing that is generated when the listing is created. Note: This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return self
     */
