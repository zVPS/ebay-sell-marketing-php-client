...
class CouponConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        'coupon_code' => null,
        'coupon_type' => null,
        'max_coupon_redemption_per_user' => null
    ];
     ...
     * Sets coupon_code
     *
     * @param string|null $coupon_code A unique code that buyers can use during checkout to receive a discount. The code must be unique across eBay. The code must be from 8-15 alphanumeric characters and can contain no more than two dashes ( - ). This is required when the promotion type is CODED_COUPON.
     *
     * @return self
     */
