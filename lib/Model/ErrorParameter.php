 ...
 *
 * @category Class
 * @description A name/value pair that provides parameter details regarding a warning or error condition.
 * @package  Ebay\Sell\Marketing
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ErrorParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets value
     *
     * @param string|null $value The value that was set for the element specified in the name field.
     *
     * @return self
     */
