 ...
 *
 * @category Class
 * @description This type defines how the Promoted Listing fee is calculated when &lt;b&gt;fundingModel&lt;/b&gt; is set to &lt;code&gt;COST_PER_SALE&lt;/code&gt;.
 * @package  Ebay\Sell\Marketing
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class FundingStrategy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['funding_model'] = isset($data['funding_model']) ? $data['funding_model'] : null;
    }
    ...
    {
        return $this->container['funding_model'];
    }

    /**
     * Sets funding_model
     *
     * @param string|null $funding_model Indicates the model that eBay uses to calculate the Promoted Listings fee. Currently, only COST_PER_SALE is supported. Default: COST_PER_SALE For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:FundingModelEnum'>eBay API documentation</a>
     *
     * @return self
     */
    public function setFundingModel($funding_model)
    {
        $this->container['funding_model'] = $funding_model;
