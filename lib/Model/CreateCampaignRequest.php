...
class CreateCampaignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'campaign_criterion' => '\Ebay\Sell\Marketing\Model\CampaignCriterion',
        'campaign_name' => 'string',
        'end_date' => 'string',
        'funding_strategy' => '\Ebay\Sell\Marketing\Model\FundingStrategy',
     ...
     *
     * @return \Ebay\Sell\Marketing\Model\CampaignCriterion|null
     */
     ...
     *
     * @param \Ebay\Sell\Marketing\Model\CampaignCriterion|null $campaign_criterion campaign_criterion
     *
     * @return self
     */
     ...
     * Sets campaign_name
     *
     * @param string|null $campaign_name A seller-defined name for the campaign. This value must be unique for the seller. You can use any alphanumeric characters in the name, except the less than (&lt;) or greater than (&gt;) characters.Max length: 80 characters
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param string|null $end_date The date and time the campaign ends, in UTC format (yyyy-MM-ddThh:mm:ssZ). If this field is blank (code&gt;null), it indicates a campaign that has no end date. For display purposes, convert this time into the local time of the seller.
     *
     * @return self
     */
     ...
     *
     * @return \Ebay\Sell\Marketing\Model\FundingStrategy|null
     */
     ...
     *
     * @param \Ebay\Sell\Marketing\Model\FundingStrategy|null $funding_strategy funding_strategy
     *
     * @return self
     */
     ...
     * Sets marketplace_id
     *
     * @param string|null $marketplace_id The ID of the eBay marketplace where the campaign is hosted. Note the X-EBAY-C-MARKETPLACE-Id header value is ignored for this purpose. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/ba:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return self
     */
