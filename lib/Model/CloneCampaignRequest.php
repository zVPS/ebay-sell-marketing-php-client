...
class CloneCampaignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets campaign_name
     *
     * @param string|null $campaign_name A seller-defined name for the newly-cloned campaign. This value must be unique for the seller. You can use any alphanumeric characters in the name, except the less than (&lt;) or greater than (&gt;) characters.Max length: 80 characters
     *
     * @return self
     */
