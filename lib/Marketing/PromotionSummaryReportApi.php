...
class PromotionSummaryReportApi
{
     ...
     * @return \Ebay\Sell\Marketing\Model\SummaryReportResponse
     */
     ...
     * @throws \Ebay\Sell\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Marketing\Model\SummaryReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPromotionSummaryReportWithHttpInfo($marketplace_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Sell\Marketing\Model\SummaryReportResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Sell\Marketing\Model\SummaryReportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ebay\Sell\Marketing\Model\SummaryReportResponse';
