...
class Campaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $campaign_status Indicates the status of the campaign, such as RUNNING, PAUSED, and ENDED. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:CampaignStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
