...
class UpdateCampaignIdentificationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets end_date
     *
     * @param string|null $end_date The new date and time the campaign ends, in UTC format (yyyy-MM-ddThh:mm:ssZ). If this field is blank (code&gt;null), it indicates a campaign that has no end date. For display purposes, convert this time into the local time of the seller.
     *
     * @return self
     */
