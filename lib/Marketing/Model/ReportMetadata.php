...
class ReportMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'dimension_metadata' => '\Ebay\Sell\Marketing\Model\DimensionMetadata[]',
        'max_number_of_dimensions_to_request' => 'int',
        'max_number_of_metrics_to_request' => 'int',
        'metric_metadata' => '\Ebay\Sell\Marketing\Model\MetricMetadata[]',
        'report_type' => 'string'
    ];
     ...
     *
     * @return \Ebay\Sell\Marketing\Model\DimensionMetadata[]|null
     */
     ...
     *
     * @param \Ebay\Sell\Marketing\Model\DimensionMetadata[]|null $dimension_metadata A list containing the metadata for the dimension used in the report.
     *
     * @return self
     */
     ...
     *
     * @return \Ebay\Sell\Marketing\Model\MetricMetadata[]|null
     */
     ...
     *
     * @param \Ebay\Sell\Marketing\Model\MetricMetadata[]|null $metric_metadata A list containing the metadata for the metrics in the report.
     *
     * @return self
     */
     ...
     * Sets report_type
     *
     * @param string|null $report_type The report_type, as specified in the request to create the report task. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/plr:ReportTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
