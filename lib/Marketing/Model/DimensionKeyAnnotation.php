...
class DimensionKeyAnnotation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets annotation_key
     *
     * @param string|null $annotation_key An annotation key associated with the dimension.
     *
     * @return self
     */
     ...
     * Sets data_type
     *
     * @param string|null $data_type The data type of the annotation key value. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/plr:DataTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
