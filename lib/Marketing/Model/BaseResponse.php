...
class BaseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'warnings' => '\Ebay\Sell\Marketing\Model\Error[]'
    ];
