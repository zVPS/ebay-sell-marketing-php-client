...
class InventoryCriterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'inventory_items' => '\Ebay\Sell\Marketing\Model\InventoryItem[]',
        'listing_ids' => 'string[]',
        'rule_criteria' => '\Ebay\Sell\Marketing\Model\RuleCriteria'
    ];
     ...
     * Sets listing_ids
     *
     * @param string[]|null $listing_ids An array of eBay listing IDs to be added to the promotion. Note: The request can have either inventoryItems or listingIds, but not both. Required: All listings in a promotion must offer an electronic payment method. Maximum: 500 parent items Maximum SKU or custom label length: 50 characters Required if InventoryCriterionType is set to INVENTORY_BY_VALUE, you must specify either inventoryItems or listingIds.
     *
     * @return self
     */
     ...
     * Gets rule_criteria
     *
     * @return \Ebay\Sell\Marketing\Model\RuleCriteria|null
     */
     ...
     * Sets rule_criteria
     *
     * @param \Ebay\Sell\Marketing\Model\RuleCriteria|null $rule_criteria rule_criteria
     *
     * @return self
     */
